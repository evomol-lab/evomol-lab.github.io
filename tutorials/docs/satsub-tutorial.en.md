...
![Nucleotide statistics](Nucleotide1.png)
...
![Nucleotide table](Nucleotide-table.png)
...
![Nucleotide Frequency](Nucleotide-Freq1.png)
...
![Nucleotide Frequency 2](Nucleotide-freq-2.png)

### Codon usage and RSCU

![Codon Usage](CodonUsage.png)
...
![RSCU](relative-synonymous-codon-usage-rscu.png)

### Directional base-pair frequencies

![Directional Base-Pair](Directional.png)
...
![Amino-acid statistics](AA2.png)

---

## 5. Substitution saturation tab — the main event

![Substitution saturation](SatSub-plots.png)
