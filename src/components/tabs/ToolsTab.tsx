...
const tools: Tool[] = [
  {
    ...
    links: [
      { label: "Go to CaRinDB", url: "https://bioinfo.imd.ufrn.br/CaRinDB/" },
      { label: "CaRinDB's Publication", url: "https://academic.oup.com/bioinformaticsadvances/article/6/1/vbaf313/8440752" }
    ]
  },
  {
    name: "SlyTheRINs",
    ...
    links: [
      { label: "Go to SlyTheRins", url: "https://slytherins.streamlit.app" },
      { label: "SlyTheRINs preprint", url: "https://www.biorxiv.org/content/10.64898/2026.02.26.708270v1" }
    ]
  },
  {
  ...
  {
    name: "Sauron (yes, it is from the Lord of the Rings!)",
    image: "Sauron-logo.png",
    description: "Sauron is a Residue Interaction Network (RIN) Calculator that identifies and maps intra-molecular interactions in protein structures. It analyzes PDB and MMCIF files to calculate interactions such as hydrogen bonds, salt bridges, disulfide bonds, and van der Waals contacts, outputting node and edge files perfectly suited for network analysis.",
    links: [{ label: "Sauron's GitHub", url: "https://github.com/evomol-lab/Sauron" }]
  },
  {
    name: "RevelioPlots",
    ...
    links: [
      ...
      { label: "RevelioPlots preprint", url: "https://www.biorxiv.org/content/10.64898/2026.02.23.707401v1" }
    ]
  },
  {
    name: "Lumos Networks",
    ...
    links: [
      { label: "Go to Lumos Networks", url: "https://lumos-networks.streamlit.app/" },
      { label: "Lumos Networks' GitHub", url: "https://github.com/evomol-lab/lumos-networks" }
    ]
  },
  {
    ...
    links: [
      { label: "Go to DDEA", url: "https://ddealley.streamlit.app/" },
      { label: "DDEA's GitHub", url: "https://github.com/evomol-lab/DDEA" }
    ]
  },
  {
    name: "Rictusempra",
    ...
    links: [
      { label: "Go to Rictusempra", url: "https://rictusempra.streamlit.app" },
      { label: "Rictusempra's GitHub", url: "https://github.com/evomol-lab/rictusempra" }
    ]
  },
  {
